...
function App() {
  let router = createBrowserRouter([
    { path: '' , element: <Layout />, children: [
      ...
      { path: "brandproduct/:brandId", element: <ProtuctedRoute><BrandProduct /></ProtuctedRoute>  },
      { path: "products", element: <Products /> },
      { path: "cart", element: <ProtuctedRoute><Cart /></ProtuctedRoute> },
      { path: "categories", element: <ProtuctedRoute><Catergories /></ProtuctedRoute>  },
      { path: "categoryproduct/:catId", element: <ProtuctedRoute><CategoryProduct /></ProtuctedRoute>  },
      { path: "wishlist", element: <ProtuctedRoute><WishList /></ProtuctedRoute>  },
      { path: "productdetails/:id", element: <ProtuctedRoute><ProductDetails /></ProtuctedRoute>  },
      { path: "shippingaddress/:cartId", element: <ProtuctedRoute><ShippingAddress /></ProtuctedRoute>  },
      { path: "allorders", element: <ProtuctedRoute><UserOrders /></ProtuctedRoute>  },
